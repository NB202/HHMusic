...
import com.hhmusic.fragment.DownFragment;
import com.hhmusic.fragment.DownMusicFragment;
...
public class DownActivity extends BaseActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(DownMusicFragment.newInstance("/storage/emulated/0/hhmusic", false, null), "单曲");
