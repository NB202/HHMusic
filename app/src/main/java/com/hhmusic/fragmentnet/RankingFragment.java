...
import com.hhmusic.activity.RankPlaylistActivity;
import com.hhmusic.fragment.AttachFragment;
import com.hhmusic.entity.BillboardInfo;
...
public class RankingFragment extends AttachFragment {
    ...
    public static int BILLBOARD_NET_MUSIC = 24;
    ...
    , BILLBOARD_EU_UK ,BILLBOARD_NET_MUSIC,BILLBOARD_CLASSIC_OLD};
    ...
    private void loadData() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    JsonObject jsonObject = HttpUtil.getResposeJsonObject(BMA.Billboard.billSongList(BILLBOARD_CLASSIC_OLD, 0, 3));
