...
import com.hhmusic.activity.DownActivity;
...
public class DownService extends Service {
    public static final String ADD_DOWNTASK = "com.hhmusic.downtaskadd";
    public static final String ADD_MULTI_DOWNTASK = "com.hhmusic.multidowntaskadd";
    public static final String CANCLE_DOWNTASK = "com.hhmusic.cacletask";
    public static final String CANCLE_ALL_DOWNTASK = "com.hhmusic.caclealltask";
    public static final String START_ALL_DOWNTASK = "com.hhmusic.startalltask";
    public static final String RESUME_START_DOWNTASK = "com.hhmusic.resumestarttask";
    public static final String PAUSE_TASK = "com.hhmusic.pausetask";
    public static final String PAUSE_ALLTASK = "com.hhmusic.pausealltask";

    public static final String UPDATE_DOWNSTAUS = "com.hhmusic.updatedown";
    public static final String TASK_STARTDOWN = "com.hhmusic.taskstart";
    public static final String TASKS_CHANGED = "com.hhmusic.taskchanges";
    ...
    private String getDownSave() {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
            File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/hhmusic/");
            if (!file.exists()) {
    ...
    private Notification getNotification(boolean complete) {
        ...
        nowPlayingIntent.setComponent(new ComponentName("com.hhmusic", "com.hhmusic.activity.DownActivity"));
        PendingIntent clickIntent = PendingIntent.getActivity(this,0,nowPlayingIntent,PendingIntent.FLAG_UPDATE_CURRENT);
        remoteViews.setImageViewResource(R.id.image, R.drawable.placeholder_disk_210);
        if(complete){
            remoteViews.setTextViewText(R.id.title, "hhmusic" );
