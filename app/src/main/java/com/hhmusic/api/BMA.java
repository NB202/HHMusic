...
public class BMA {
    ...
    public static final String FORMATE = "entity";
    public static final String BASE = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.8.1&format=" + FORMATE;
