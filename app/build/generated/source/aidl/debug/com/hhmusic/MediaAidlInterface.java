 ...
 * Original file: D:\\QMWork\\HHMusic\\app\\src\\main\\aidl\\com\\hhmusic\\MediaAidlInterface.aidl
 */
package com.hhmusic;
public interface MediaAidlInterface extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.hhmusic.MediaAidlInterface
{
private static final java.lang.String DESCRIPTOR = "com.hhmusic.MediaAidlInterface";
...
/**
 * Cast an IBinder object into an com.hhmusic.MediaAidlInterface interface,
 * generating a proxy if needed.
 */
public static com.hhmusic.MediaAidlInterface asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.hhmusic.MediaAidlInterface))) {
return ((com.hhmusic.MediaAidlInterface)iin);
}
return new com.hhmusic.MediaAidlInterface.Stub.Proxy(obj);
}
...
case TRANSACTION_getPlayinfos:
{
data.enforceInterface(descriptor);
java.util.Map _result = this.getPlayinfos();
reply.writeNoException();
...
case TRANSACTION_secondPosition:
{
data.enforceInterface(descriptor);
int _result = this.secondPosition();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
{
data.enforceInterface(descriptor);
com.hhmusic.service.MusicTrack _result = this.getCurrentTrack();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
int _arg0;
_arg0 = data.readInt();
com.hhmusic.service.MusicTrack _result = this.getTrack(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
case TRANSACTION_isTrackLocal:
{
data.enforceInterface(descriptor);
boolean _result = this.isTrackLocal();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
case TRANSACTION_getAlbumPath:
{
data.enforceInterface(descriptor);
java.lang.String _result = this.getAlbumPath();
reply.writeNoException();
reply.writeString(_result);
return true;
}
case TRANSACTION_getAlbumPathtAll:
{
data.enforceInterface(descriptor);
java.lang.String[] _result = this.getAlbumPathtAll();
reply.writeNoException();
...
private static class Proxy implements com.hhmusic.MediaAidlInterface
{
...
@Override public void open(java.util.Map infos, long[] list, int position) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeMap(infos);
...
@Override public void enqueue(long[] list, java.util.Map infos, int action) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public java.util.Map getPlayinfos() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getPlayinfos, _data, _reply, 0);
_reply.readException();
java.lang.ClassLoader cl = (java.lang.ClassLoader)this.getClass().getClassLoader();
...
@Override public int secondPosition() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_secondPosition, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
@Override public com.hhmusic.service.MusicTrack getCurrentTrack() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.hhmusic.service.MusicTrack _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurrentTrack, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.hhmusic.service.MusicTrack.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.hhmusic.service.MusicTrack getTrack(int index) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.hhmusic.service.MusicTrack _result;
...
@Override public boolean isTrackLocal() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isTrackLocal, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
@Override public java.lang.String getAlbumPath() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getAlbumPath, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
@Override public java.lang.String[] getAlbumPathtAll() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String[] _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getAlbumPathtAll, _data, _reply, 0);
_reply.readException();
...
@Override public void timing(int time) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(time);
mRemote.transact(Stub.TRANSACTION_timing, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_getPlayinfos = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
...
static final int TRANSACTION_playlistChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
...
static final int TRANSACTION_getQueueItemAtPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getQueueSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getQueuePosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getQueueHistoryPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getQueueHistorySize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getQueueHistoryList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_duration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_position = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_secondPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_seek = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_seekRelative = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getAudioId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getCurrentTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getNextAudioId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_getPreviousAudioId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getArtistId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_getAlbumId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_getArtistName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_getTrackName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_isTrackLocal = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_getAlbumName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_getAlbumPath = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getAlbumPathtAll = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_getPath = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_getShuffleMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_removeTracks = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_removeTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_removeTrackAtPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_getRepeatMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_getMediaMountedCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_getAudioSessionId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_setLockscreenAlbumArt = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_exit = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_timing = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
}
public void openFile(java.lang.String path) throws android.os.RemoteException;
public void open(java.util.Map infos, long[] list, int position) throws android.os.RemoteException;
public void stop() throws android.os.RemoteException;
public void pause() throws android.os.RemoteException;
public void play() throws android.os.RemoteException;
public void prev(boolean forcePrevious) throws android.os.RemoteException;
public void next() throws android.os.RemoteException;
public void enqueue(long[] list, java.util.Map infos, int action) throws android.os.RemoteException;
public java.util.Map getPlayinfos() throws android.os.RemoteException;
...
public int secondPosition() throws android.os.RemoteException;
...
public com.hhmusic.service.MusicTrack getCurrentTrack() throws android.os.RemoteException;
public com.hhmusic.service.MusicTrack getTrack(int index) throws android.os.RemoteException;
...
public boolean isTrackLocal() throws android.os.RemoteException;
public java.lang.String getAlbumName() throws android.os.RemoteException;
public java.lang.String getAlbumPath() throws android.os.RemoteException;
public java.lang.String[] getAlbumPathtAll() throws android.os.RemoteException;
...
public void timing(int time) throws android.os.RemoteException;
}
